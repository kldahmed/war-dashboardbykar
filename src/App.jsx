...
const API_KEY = "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";
    ...
    <div style={{ minHeight: "100vh", background: "#060606", color: "#e4e0d8", direction: "rtl", fontFamily: "'Cairo','Noto Sans Arabic',sans-serif" }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media(max-width:700px){.news-grid,.vid-grid{grid-template-columns:1fr!important}.live-layout,.x-layout{grid-template-columns:1fr!important}.hdr{flex-direction:column!important;align-items:flex-start!important}}
