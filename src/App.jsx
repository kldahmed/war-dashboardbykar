    ...
    <div style={{ minHeight:"100vh", background:"#060606", color:"#e4e0d8", direction:"rtl", fontFamily:"'Cairo','Noto Sans Arabic',sans-serif" }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @media(max-width:700px){.news-grid,.vid-grid{grid-template-columns:1fr!important}.x-layout{grid-template-columns:1fr!important}.hdr{flex-direction:column!important;align-items:flex-start!important}}
