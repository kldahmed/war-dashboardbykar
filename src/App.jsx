      ...
      <div style={{ position: "relative", background: "linear-gradient(180deg,#060e1a,#081420 50%,#0a1008)", overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              "linear-gradient(rgba(36,113,163,.06) 1px,transparent 1px),linear-gradient(90deg,rgba(36,113,163,.06) 1px,transparent 1px)",
        ...
        {MAP_HOTSPOTS.map((spot) => {
          ...
          return (
            <div
              key={spot.id}
              onClick={() => setSelected(isSel ? null : spot)}
              style={{
                position: "absolute",
                left: `${spot.x}%`,
                top: `${spot.y}%`,
            ...
            >
              <div
                style={{
                  ...
                  left: "50%",
                  transform: "translate(-50%,-50%)",
                  width: `${spot.size * 2.5}px`,
                  height: `${spot.size * 2.5}px`,
                  borderRadius: "50%",
              ...
              <div
                style={{
                  ...
                  left: "50%",
                  transform: "translate(-50%,-50%)",
                  width: `${spot.size * 1.8}px`,
                  height: `${spot.size * 1.8}px`,
                  borderRadius: "50%",
                  border: `1px solid ${col}`,
                  opacity: 0.5,
                  animation: "ping 2s ease-in-out infinite .5s",
                }}
              />
              <div
                style={{
                  ...
                  height: `${spot.size}px`,
                  borderRadius: "50%",
                  background: `radial-gradient(circle,${col} 0%,${col}88 60%,transparent 100%)`,
                  boxShadow: `0 0 ${spot.size}px ${col}88`,
                  border: `2px solid ${col}cc`,
              ...
              >
                <span
                  style={{
                    ...
                    animation: spot.intensity > 80 ? "pulse 1s infinite" : "none",
                  }}
                />
...
function XFeed() {
  ...
  return (
    <div className="x-layout" style={{ display: "grid", gridTemplateColumns: "260px 1fr", gap: "16px", alignItems: "start" }}>
        ...
        {X_ACCOUNTS.map((acc) => {
          ...
          return (
            <div
              ...
              style={{
                background: active ? `${acc.color}20` : "#0f0f0f",
                border: `1px solid ${active ? `${acc.color}77` : "rgba(255,255,255,.06)"}`,
                borderRadius: "11px",
                padding: "10px 13px",
                cursor: "pointer",
                display: "flex",
                ...
                gap: "10px",
                transition: "all .2s",
                boxShadow: active ? `0 0 12px ${acc.color}33` : "none",
              }}
            >
              <div
                style={{
      ...
      <div style={{ background: "#0d0d0d", border: "1px solid rgba(255,255,255,.07)", borderRadius: "14px", overflow: "hidden" }}>
        <div style={{ padding: "12px 16px", background: "#0f0f0f", borderBottom: "1px solid rgba(255,255,255,.05)", display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
    ...
    >
      {!imgErr && (
        <div style={{ position: "relative", height: "148px", overflow: "hidden" }}>
          <img
            src={getImg(item.category, index)}
            alt=""
            onError={() => setImgErr(true)}
            style={{ width: "100%", height: "100%", objectFit: "cover", filter: "brightness(.58) saturate(.65)" }}
            loading="lazy"
          />
        ...
        {open && (
          <p
            style={{
              ...
              direction: "rtl",
              textAlign: "right",
              borderTop: `1px solid ${col.accent}33`,
              paddingTop: "10px",
            }}
          >
            {item.summary}
      ...
      {playing ? (
        ...
        <div onClick={() => setPlaying(true)} style={{ position: "relative", cursor: "pointer" }}>
          <img
            ...
            alt={item.title}
            style={{ width: "100%", aspectRatio: "16/9", objectFit: "cover", display: "block", filter: "brightness(.72)" }}
            loading="lazy"
            onError={(e) => {
              e.currentTarget.src = getImg(item.category, index);
            }}
          />
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                boxShadow: "0 4px 20px rgba(220,0,0,.5)",
              }}
            >
...
export default function Dashboard() {
  ...
  const fetchVideos = useCallback(async (c, force = false) => {
    ...
    try {
      ...
      if (!Array.isArray(items) || items.length === 0) {
        throw new Error("API did not return live videos array");
      }
      ...
      const msg = err?.message || String(err);
      setErrV(`فشل جلب الفيديوهات الحية: ${msg}`);
      setVideos([]);
    } finally {
      setLoadV(false);
    }
    ...
    <div style={{ minHeight: "100vh", background: "#060606", color: "#e4e0d8", direction: "rtl", fontFamily: "'Cairo','Noto Sans Arabic',sans-serif" }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        @keyframes ping{0%{transform:translate(-50%,-50%) scale(.6);opacity:.8}100%{transform:translate(-50%,-50%) scale(1.4);opacity:0}}
        ...
        @media(max-width:700px){
          ...
          .x-layout{grid-template-columns:1fr !important}
          .hdr{flex-direction:column !important;align-items:flex-start !important}
        }
        ::-webkit-scrollbar{width:4px}
        ::-webkit-scrollbar-thumb{background:#c8960c33}
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: active ? CAT_COLORS[c.id].light : "#333",
                    borderRadius: "6px",
                    padding: "5px 12px",
                    cursor: "pointer",
                    fontSize: "12px",
      ...
      <div style={{ padding: "18px 20px 50px" }}>
          ...
          <div>
            ...
            {errN && !loadN && (
              ...
              >
                ...
                <div style={{ color: "#444", fontSize: "12px", marginBottom: "12px" }}>
                  الأخبار الحية فشلت. هذا يعني أن /api/claude لم يرجع JSON صالح للأخبار.
                </div>
                <button
            ...
            {!loadN && !errN && news.length === 0 && (
              <div style={{ textAlign: "center", color: "#666", padding: "60px" }}>
                لا توجد أخبار حية متاحة حالياً
              </div>
            )}
              ...
              <div>
                <div style={{ display: "flex", gap: "8px", marginBottom: "15px", flexWrap: "wrap", alignItems: "center" }}>
                  ...
                  <span style={{ color: "#1a1a1a", fontSize: "11px", marginRight: "auto" }}>
                    {news.length} خبر {updated ? `— ${updated}` : ""}
                  </span>
                </div>
        ...
        {tab === "stats" && <StatsPanel news={news.length > 0 ? news : DEMO_NEWS} tensionData={tensionData} />}
        ...
        {tab === "videos" && (
          <div>
            ...
            {!loadV && !errV && videos.length === 0 && (
              <div style={{ textAlign: "center", color: "#666", padding: "60px" }}>
                لا توجد فيديوهات حية متاحة حالياً
              </div>
            )}
            ...
            {!loadV && videos.length > 0 && (
              <div className="vid-grid">
                {videos.map((v, i) => (
                  <VideoCard key={`${v.youtubeId}-${i}`} item={v} index={i} />
                ))}
              </div>
            )}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 285px", gap: "15px", alignItems: "start" }}>
            <div style={{ background: "#0a0800", borderRadius: "16px", overflow: "hidden", border: `1px solid ${gold}2a` }}>
              <div style={{ padding: "10px 14px", background: "#0d0b00", borderBottom: `1px solid ${gold}1a`, display: "flex", alignItems: "center", gap: "9px", flexWrap: "wrap" }}>
                ...
                <a
                  href={`https://www.youtube.com/watch?v=${liveCh.youtubeId}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    marginRight: "auto",
