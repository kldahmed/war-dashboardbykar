...
export const SECTION_ROUTES = [
  ...
  { id: "news-operations", path: "/admin/news-operations", icon: "🛠️", tier: "public", titleAr: "تشغيل الأخبار", titleEn: "News Operations", descriptionAr: "لوحة تشغيل المصادر والسعة وإعادة المعالجة", descriptionEn: "Operations panel for sources, capacity, and reprocessing" },
  { id: "news-analytics", path: "/admin/news-analytics", icon: "📊", tier: "public", titleAr: "تحليلات الأخبار", titleEn: "News Analytics", descriptionAr: "عدادات يومية، جودة، توزيع، وتنبيهات الأداء", descriptionEn: "Daily counters, quality, distributions, and performance alerts" },
  { id: "news-sources", path: "/admin/news-sources", icon: "🧭", tier: "public", titleAr: "مصادر الأخبار", titleEn: "News Sources", descriptionAr: "حالة المصادر، الفشل، التكرار، ومعدلات السحب", descriptionEn: "Source health, failure, duplicates, and polling rates" },
  { id: "news-clusters", path: "/admin/news-clusters", icon: "🧩", tier: "public", titleAr: "تجميع التكرار", titleEn: "News Clusters", descriptionAr: "عرض المجموعات المتشابهة وربط المصادر", descriptionEn: "View similarity clusters and linked sources" },
  { id: "news-ingest", path: "/admin/news-ingest", icon: "📥", tier: "public", titleAr: "قياس الجلب", titleEn: "Ingest Monitor", descriptionAr: "عدادات دقيقة لكل خبر تم جلبه مع تفاصيل كاملة لأداء كل مصدر", descriptionEn: "Precise counters for every fetched article with full per-source performance details" },
