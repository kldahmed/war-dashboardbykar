...
export const SECTION_ROUTES = [
  ...
  { id: "news-ingest", path: "/admin/news-ingest", icon: "📥", tier: "admin", titleAr: "قياس الجلب", titleEn: "Ingest Monitor", descriptionAr: "عدادات دقيقة لكل خبر تم جلبه مع تفاصيل كاملة لأداء كل مصدر", descriptionEn: "Precise counters for every fetched article with full per-source performance details" },
